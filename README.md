...
<img src="./logo.png" alt="BearTheme Logo" width="128" height="128" />

# BearTheme 🐻

**Um conjunto completo de 13 temas elegantes, modernos e confortáveis para o Visual Studio Code.**

[![Version](https://img.shields.io/badge/version-1.3.0-blue.svg)](https://marketplace.visualstudio.com/items?itemName=GabrielTeles.beartheme)
...
O **BearTheme** é uma coleção de temas cuidadosamente desenhados com suporte completo tanto para **destaque de sintaxe (TextMate 60 tokens)** quanto para **interface completa do editor (workbench com mais de 85 cores)**, cobrindo Activity Bar, Side Bar, Terminal Integrado, Abas, Status Bar, Breadcrumbs e Git Decorations.

---

## 🎨 Catálogo de Temas (13 Variações)

### 🍦 Coleção Pastel (Estilo Catppuccin)
Tons aveludados, macios e suaves que proporcionam máximo conforto visual:
...
* **Bear Pastel Frappé (Dark)** — Tom cinza-ardósia médio fresco (`#303446`), ideal para reduzir o cansaço dos olhos.
...
3. Escolha qualquer uma das variações do **BearTheme**!
